...
As of Lucene 2.4, Lucene query api has adopted "DocIdSet":http://lucene.apache.org/java/3_4_0/api/core/org/apache/lucene/search/DocIdSet.html, and "DocIdSetIterator":http://lucene.apache.org/java/3_4_0/api/core/org/apache/lucene/search/DocIdSetIterator.html abstractions, which opened doors for various query optimizations. (IMHO, this is one of the best improvements in Lucene from an API stand point.)
...
"http://linkedin.jira.com/wiki/display/BOBO/Facet+Query":http://linkedin.jira.com/wiki/display/BOBO/Facet+Query
